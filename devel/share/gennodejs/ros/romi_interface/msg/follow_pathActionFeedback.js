...
let follow_pathFeedback = require('./follow_pathFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class follow_pathActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new follow_pathFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = follow_pathFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new follow_pathActionFeedback(null);
    ...
    data.feedback = follow_pathFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new follow_pathActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = follow_pathFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new follow_pathFeedback()
    }
...
module.exports = follow_pathActionFeedback;
