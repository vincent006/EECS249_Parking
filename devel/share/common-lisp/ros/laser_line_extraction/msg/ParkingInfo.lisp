...
(cl:defmethod cl:initialize-instance :after ((m <ParkingInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ParkingInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laser_line_extraction-msg:<ParkingInfo> is deprecated: use laser_line_extraction-msg:ParkingInfo instead.")))

(cl:ensure-generic-function 'isParking-val :lambda-list '(m))
(cl:defmethod isParking-val ((m <ParkingInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_line_extraction-msg:isParking-val is deprecated.  Use laser_line_extraction-msg:isParking instead.")
  (isParking m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <ParkingInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_line_extraction-msg:width-val is deprecated.  Use laser_line_extraction-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'depth-val :lambda-list '(m))
(cl:defmethod depth-val ((m <ParkingInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_line_extraction-msg:depth-val is deprecated.  Use laser_line_extraction-msg:depth instead.")
  (depth m))

(cl:ensure-generic-function 'top_y-val :lambda-list '(m))
(cl:defmethod top_y-val ((m <ParkingInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_line_extraction-msg:top_y-val is deprecated.  Use laser_line_extraction-msg:top_y instead.")
  (top_y m))

(cl:ensure-generic-function 'bottom_y-val :lambda-list '(m))
(cl:defmethod bottom_y-val ((m <ParkingInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_line_extraction-msg:bottom_y-val is deprecated.  Use laser_line_extraction-msg:bottom_y instead.")
  (bottom_y m))

(cl:ensure-generic-function 'out_x-val :lambda-list '(m))
(cl:defmethod out_x-val ((m <ParkingInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_line_extraction-msg:out_x-val is deprecated.  Use laser_line_extraction-msg:out_x instead.")
  (out_x m))

(cl:ensure-generic-function 'in_x-val :lambda-list '(m))
(cl:defmethod in_x-val ((m <ParkingInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser_line_extraction-msg:in_x-val is deprecated.  Use laser_line_extraction-msg:in_x instead.")
  (in_x m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ParkingInfo>)))
  ...
  "laser_line_extraction/ParkingInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ParkingInfo)))
  "Returns string type for a message object of type 'ParkingInfo"
  "laser_line_extraction/ParkingInfo")
